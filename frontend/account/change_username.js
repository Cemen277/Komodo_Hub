...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const input_placeholder = document.getElementById("change_username");
    const delete_button = document.getElementById("delete_button")
    console.log(user_id)

    delete_button.addEventListener("click", function(){
        let username_input = change_username.value.trim();
    ...
    .then(data => {
        input_placeholder.placeholder = data.username;
    })
    .catch(error => {
        console.error("Error fetching user info:", error);
    });
    update_button.addEventListener("click", function(){
        const new_username = document.getElementById("change_username").value.trim()
        ...
        fetch("https://komodo-hub.onrender.com/api/update_username/", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
        ...
        .then(data => {
            input_placeholder.placeholder = new_username;
