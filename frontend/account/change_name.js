...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const input_placeholder = document.getElementById("change_name");
    const delete_button = document.getElementById("delete_button")
    console.log(user_id)

    delete_button.addEventListener("click", function(){
        let name_input = change_name.value.trim();
    ...
    .then(data => {
        input_placeholder.placeholder = data.full_name;
    })
    .catch(error => {
        console.error("Error fetching user info:", error);
    });
    update_button.addEventListener("click", function(){
        const new_full_name = document.getElementById("change_name").value.trim()
        if (!user_id || !new_full_name) {
        ...
        .then(data => {
            input_placeholder.placeholder = new_full_name;
